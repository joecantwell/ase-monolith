...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(ActorUI.Web.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(ActorUI.Web.App_Start.NinjectWebCommon), "Stop")]
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind(x => x
               ...
               .SelectAllClasses()
               .Join.FromAssembliesMatching("ActorUI.Web.dll")
               .SelectAllClasses()
